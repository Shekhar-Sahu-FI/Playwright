...
export class ItemMaster {
  ...
  constructor(page: Page) {
    ...
    this.subgroup = page.getByPlaceholder('Select Subgroup');
  ...
  async checkFieldParameter() {
    ...
    await expect(this.makeManagementTypeNo.locator('option')).toHaveText([
      'Select Make Management Type',
      'None',
      'All',
      'Selected',
    ]);
    await expect(this.dimensionIn.locator('option')).toHaveText([
      'Select Dimension In',
      'Length Only',
      'Length & Width',
    ]);
